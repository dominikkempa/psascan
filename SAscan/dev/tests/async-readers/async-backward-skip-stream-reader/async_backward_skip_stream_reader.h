#ifndef __ASYNC_BACKWARD_SKIP_STREAM_READER_H_INCLUDED
#define __ASYNC_BACKWARD_SKIP_STREAM_READER_H_INCLUDED
...
#endif  // __ASYNC_BACKWARD_SKIP_STREAM_READER_H_INCLUDED
