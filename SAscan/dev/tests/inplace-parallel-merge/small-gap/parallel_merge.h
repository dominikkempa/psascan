// XXX add a description of the implement method here and comment on the
//     fact that this module is completely independent piece of code.
//     In particular, it is perfectly doable to explain what this whole
//     module does without knowing anything about how SAscan algorithm works.
...
template<typename T>
void merge(T *tab, long n1, long n2, gap_array *gap, long pagesize_bits, long max_threads) {
  unsigned pagesize = (1U << pagesize_bits);
  long length = n1 + n2;
