...
void test_big_random(long length, long sigma, long queries) {
  ...
  fprintf(stderr, "Building correct rank: ");
  start = utils::wclock();
  context_rank_4n *correct_rank = new context_rank_4n(text, length);
  fprintf(stderr, "%.2Lf\n", utils::wclock() - start);

  fprintf(stderr, "Building tested rank: ");
  start = utils::wclock();
  ...
  for (long q = 0; q < queries; ++q) {
    if (q % 10000 == 0)
      fprintf(stderr, "\rprogress: %.2Lf", (100.L * q) / queries);
...
int main(int, char **) {
  ...
  test_random(10000,   1000,    5,    10000);
  test_random(10000,   1000,    20,   10000);
  test_random(10000,   1000,    128,  10000);
  test_random(10000,   1000,    256,  10000);
  test_random(100,    100000,  5,    10000);
  test_random(100,    100000,  20,   10000);
  test_random(100,    100000,  128,  10000);
  test_random(100,    10000,   256,  10000);
  test_random(100,    1000000, 5,    10000);
  test_random(100,    1000000, 20,   10000);
  test_random(100,    1000000, 128,  10000);
